...
module.exports = function ( docType, subDocType, project /*, iedRev*/ ) {
  ...
  var iedGenerator = function ( subDocType, project) {
    ...
    var iedCoverAndCheck = {
      ...
      'arrangement' : [ 'ied_cover_arrangement.docx'  , 'arrangement_check_list.xlsx'  ], // 机柜内布置图
      ...
      'installation': [ 'ied_cover_installation.docx' , 'installation_check_list.xlsx' ], // 机柜安装图
      ...
      'system_spec' : [ 'ied_cover_system_spec.docx'  , 'generic_check_list.xlsx'      ]  // 说明书
    };
    var iedList = [];
